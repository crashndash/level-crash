...
"use strict";!function(){String.prototype.capitalize=function(){return this.charAt(0).toUpperCase()+this.slice(1)};var e=function(e,t,i,a,r){$(a).each(function(a,n){t[n]=e[n],e.$watch(n,function(){$(i)[r]("option",n,e[n])})})},t=function(e,t,i){$(i).each(function(i,a){void 0!==e[a]&&(t[a]=function(){angular.isFunction(e[a])&&e[a].apply(null,arguments)})})},i=function(e,t){var i={};return e.forEach(function(e){i[e]="=event"+e.capitalize()}),t.forEach(function(e){i[e]="=opt"+e.toLowerCase().capitalize()}),i},a=function(i,a,r){return function(n,c){var o={};e(n,o,c,r,i),t(n,o,a),$(c)[i](o)}},r=angular.module("jui",[]);r.directive("juiDraggable",function(){var e=["create","start","drag","stop"],t=["disabled","addClasses","appendTo","axis","cancel","connectToSortable","containment","cursor","cursorAt","delay","distance","grid","handle","helper","iframeFix","opacity","refreshPositions","revert","revertDuration","scope","scroll","scrollSensitivity","scrollSpeed","snap","snapMode","snapTolerance","stack","zIndex"];return{restrict:"A",scope:i(e,t),link:a("draggable",e,t)}}),r.directive("juiButton",function(){var e=["create"],t=["disabled","text","icons","label"];return{restrict:"A",scope:i(e,t),link:a("button",e,t)}}),r.directive("juiButtonset",function(){var e=[],t=["disabled"];return{restrict:"A",scope:i(e,t),link:a("buttonset",e,t)}}),r.directive("juiProgressbar",function(){var e=["create","change","complete"],a=["disabled","value"];return{restrict:"A",scope:i(e,a),link:function(i,r){var n={};$(a).each(function(e,t){n[t]=i[t],i.$watch(t,function(e){"value"===t&&(e=parseInt(e,10)),$(r).progressbar("option",t,e)})}),t(i,n,e),$(r).progressbar(n)}}}),r.directive("juiDroppable",[function(){var e=["create","activate","deactivate","over","drop","out"],t=["disabled","accept","activeClass","addClasses","greedy","hoverClass","scope","tolerance"];return{restrict:"A",scope:i(e,t),link:a("droppable",e,t)}}]),r.directive("juiResizable",[function(){var e=["create","start","resize","stop"],t=["disabled","alsoResize","animate","animateDuration","animateEasing","aspectRatio","autoHide","cancel","containment","delay","distance","ghost","grid","handles","helper","maxHeight","maxWidth","minHeight","minWidth"];return{restrict:"A",scope:i(e,t),link:a("resizable",e,t)}}])}();